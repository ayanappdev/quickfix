...
import 'loginrest.dart'; // Update with the correct path

final formkey = GlobalKey<FormState>();

class MySignuprest extends StatefulWidget {
  const MySignuprest({Key? key}) : super(key: key);

  @override
  _MySignuprestState createState() => _MySignuprestState();
}

class _MySignuprestState extends State<MySignuprest> {
  ...
  Future signuprest() async {
    ...
    try {
      ...
      Navigator.pushReplacement(
        ...
        MaterialPageRoute(
          builder: (context) => RegisterRestaurantScreen(),
        ),
      );
